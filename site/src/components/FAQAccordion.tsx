...
const faqs: FAQ[] = [
  { q: 'What is ClawClawGo?', a: 'ClawClawGo is an agent kits search engine. It finds curated skill collections (kits) from GitHub, ClawHub, skills.sh, and other sources for Claude Code, Cursor, OpenClaw, and 30+ other AI agents.' },
  ...
  { q: 'What\'s in a typical kit?', a: 'A kit is a collection of skills. Each skill has a name, description, compatibility requirements, and optional scripts/docs/assets. Kits range from focused toolsets to full stacks with dozens of capabilities.' },
  ...
  { q: 'What are trust tiers?', a: 'Kits are tagged as "verified" (official sources like Anthropic, Microsoft), "community" (from known developers with GitHub stars), or "unreviewed" (new or unknown sources). Stars and forks help gauge quality.' },
]
