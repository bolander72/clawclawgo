...
features:
  ...
  - icon: 🌐
    ...
    details: Publish loadouts to the decentralized Nostr network. No accounts, no gatekeepers, no platform lock-in.
  - icon: 🔒
    title: Privacy First
    details: Automatic PII scrubbing on export. Credentials never leave your machine. You control what gets shared.
---
